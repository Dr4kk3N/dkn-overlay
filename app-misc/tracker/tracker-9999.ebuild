...
inherit bash-completion-r1 flag-o-matic linux-info meson python-any-r1 systemd vala xdg gnome2-utils #gnome.org

DESCRIPTION="A tagging metadata database, search tool and indexer"
HOMEPAGE="https://wiki.gnome.org/Projects/Tracker https://gitlab.gnome.org/GNOME/tinysparql"

#if [[ ${PV} == 9999 ]]; then
        EGIT_REPO_URI="https://gitlab.gnome.org/GNOME/tinysparql.git"
        inherit git-r3
#else
#       SRC_URI="
