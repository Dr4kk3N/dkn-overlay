...
inherit meson optfeature python-single-r1 virtualx xdg gnome2-utils #gnome.org
...
IUSE="elogind gtk-doc +ibus +networkmanager eds gdm pipewire systemd test"
...
DEPEND="
	eds? ( =gnome-extra/evolution-data-server-9999 )
	>=app-crypt/gcr-3.90.0:4=[introspection]
	>=dev-libs/glib-2.79.2:2
	>=dev-libs/gobject-introspection-1.49.1:=
	>=dev-libs/gjs-1.73.1[cairo]
	>=gui-libs/gtk-4.16.0:4[vulkan,introspection]
	=x11-wm/mutter-9999:0/15[introspection,test?]
	>=sys-auth/polkit-0.120_p20220509[introspection]
	=gnome-base/gsettings-desktop-schemas-9999[introspection]
	>=app-i18n/ibus-1.5.19
	=gnome-base/gnome-desktop-9999:4=
	networkmanager? (
	...
	systemd? (
		...
		=gnome-base/gnome-desktop-9999:4=[systemd]
	)
	...
	gui-libs/gtk:4[vulkan,introspection]
...
PDEPEND="
	gdm? ( =gnome-base/gdm-9999[introspection(+)] )
	=gnome-base/gnome-control-center-9999[networkmanager(+)?]
"
BDEPEND="
	dev-libs/libxslt
