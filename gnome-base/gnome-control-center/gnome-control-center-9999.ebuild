...
inherit flag-o-matic meson python-any-r1 virtualx xdg gnome2-utils #gnome.org

DESCRIPTION="GNOME's main interface to configure various aspects of the desktop"
HOMEPAGE="https://gitlab.gnome.org/GNOME/gnome-control-center"

#if [[ ${PV} == 9999 ]]; then
        EGIT_REPO_URI="https://gitlab.gnome.org/GNOME/gnome-control-center.git"
        inherit git-r3
#else
#       SRC_URI="
...
DEPEND="
	...
	=gui-libs/gtk-4.16.0:4[X,vulkan,wayland=]
	...
	=gnome-base/gnome-settings-daemon-9999[colord,input_devices_wacom?]
	...
	bluetooth? ( net-wireless/gnome-bluetooth:4= )
...
PDEPEND="=gnome-base/gnome-session-9999
