...
inherit linux-info meson-multilib multilib python-any-r1 toolchain-funcs xdg gnome2-utils gnome.org
...
multilib_src_configure() {
	...
	local emesonargs=(
		...
		-Dman-pages=enabled
		-Ddtrace=disabled
		-Dsystemtap=$(usex systemtap enabled disabled)
...
#		-Dintrospection=$(usex introspection enabled disabled)
		...
		-Dnls=enabled
		-Doss_fuzz=disabled
		-Dlibelf=$(usex elf enabled disabled)
		-Dmultiarch=false
