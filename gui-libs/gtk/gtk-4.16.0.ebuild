...
COMMON_DEPEND="
	...
	gstreamer? (
		>=media-libs/gstreamer-1.24.7:1.0
		>=media-libs/gst-plugins-bad-1.24.7:1.0
		|| (
			>=media-libs/gst-plugins-base-1.24.7:1.0[gles2]
			>=media-libs/gst-plugins-base-1.24.7:1.0[opengl]
		)
	)
