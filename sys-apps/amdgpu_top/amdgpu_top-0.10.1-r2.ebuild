...
declare -A GIT_CRATES=(
	[libdrm_amdgpu_sys]='https://github.com/Dr4kk3N/libdrm-amdgpu-sys-rs;b7e28f61a249a52e9d7d3644d59fe0635127483e;libdrm-amdgpu-sys-rs-%commit%'
)
...
src_prepare() {
	eapply "${FILESDIR}/${PN}-ps4_source.patch"
	eapply_user
}
