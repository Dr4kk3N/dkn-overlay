...
EAPI=8
inherit readme.gentoo-r1 meson xdg #gnome.org

DESCRIPTION="JavaScript extensions for GNOME Shell"
HOMEPAGE="https://gitlab.gnome.org/GNOME/gnome-shell-extensions"

#if [[ ${PV} == 9999 ]]; then
        EGIT_REPO_URI="https://gitlab.gnome.org/GNOME/gnome-shell-extensions.git"
        inherit git-r3
#else
#       SRC_URI="
...
RDEPEND="${DEPEND}
	...
	gnome-base/gnome-menus:4[introspection]
