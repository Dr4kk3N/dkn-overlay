...
FUSION_COMMIT="066d4a63b2c714b20b0a8073a01fda7c5c6763f6"
HIDAPI_COMMIT="f42423643ec9011c98cccc0bb790722bbbd3f30b"
...
if [[ ${PV} == "9999" ]]; then
	...
	EGIT_SUBMODULES=(
	'asmjit' '3rdparty/fusion/fusion' '3rdparty/glslang' '3rdparty/miniupnp/miniupnp' '3rdparty/rtmidi/rtmidi' '3rdparty/wolfssl'
	'3rdparty/SoundTouch/soundtouch' '3rdparty/fusion/fusion' '3rdparty/hidapi/hidapi' '3rdparty/GPUOpen/VulkanMemoryAllocator'
	)
	...
	SRC_URI="
		...
		https://github.com/RPCS3/hidapi/archive/${HIDAPI_COMMIT}.tar.gz -> ${PN}-hidapi-${HIDAPI_COMMIT}.tar.gz
...
src_prepare() {
	if [[ ${PV} != "9999" ]]; then
		...
		rmdir "${S}/3rdparty/hidapi/hidapi" || die
                mv "${WORKDIR}/hidapi-${HIDAPI_COMMIT}" "${S}/3rdparty/hidapi/hidapi" || die
